 ...
 * @since 1.0
 */
@Path("/userMgmt/v1.0/users")
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
public class UserMgmtResource {
	
	private static final LogUtil LOGGER = LogUtil.getLogger(UserMgmtResource.class);

	private static final IdentityMgmtService userMgmtService = new DBIdentityMgmtServiceImpl();
	...
	public User getUser(@PathParam("id") String id) throws FrameworkException {
		...
		User user = userMgmtService.getUser(id);
