...
public class LDAPUserStoreServiceImpl implements UserStoreService {
	
	private static final LogUtil LOGGER = LogUtil.getLogger(LDAPUserStoreServiceImpl.class);
	 ...
	 */
	@Override
	public List<Group> getMembership(String userDN) throws FrameworkException {
...
//		return groupIds.toArray(new String[groupIds.size()]);
	...
	@Override
	public List searchPrincipals(List<Attribute> atts, PrincipalType type) throws FrameworkException {
...
//		return principalIds.toArray(new String[principalIds.size()]);
	...
	/**
	 *  This retrieves user information from ldap.
	 *  
	 *  This is NOT User DN.
	 */ 
	@Override
...
//			metadata.setUniqueIdentifier(entry.getDN());
